    ...
    <script src="<?php echo base_url() ?>assets/templates/plugins/simplebar/js/simplebar.min.js"></script>
    ...
    <!--app JS-->
    <script src="<?php echo base_url() ?>assets/templates/js/app.js"></script>
  </body>
</html>